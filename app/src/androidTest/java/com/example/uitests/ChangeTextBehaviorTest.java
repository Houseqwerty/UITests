...
import com.example.uitests.IdlingResource.IdleMainActivity;
...
public class ChangeTextBehaviorTest {
    ...
    public void registerIdlingResource() {
        ActivityScenario activityScenario = ActivityScenario.launch(IdleMainActivity.class);
        activityScenario.onActivity((ActivityScenario.ActivityAction<IdleMainActivity>) activity -> {
